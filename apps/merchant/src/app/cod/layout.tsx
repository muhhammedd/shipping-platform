...
import { Home, Package, PlusCircle, Wallet, LogOut, Bell } from 'lucide-react';
...
export default function MerchantCodLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background" dir="rtl">
      ...
      <main className="flex-1 overflow-auto pb-20">
        <div className="container max-w-4xl mx-auto p-4">{children}</div>
      </main>
